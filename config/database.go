...
func InitDB() {
	...
	dbHost := getEnv("DB_HOST", "postgresql://anniedatabase_user:zS4wHtUYiDvwuhdAxPXgCmYngVT8SuED@dpg-d4fshta4d50c73f15jeg-a.oregon-postgres.render.com/anniedatabase")
